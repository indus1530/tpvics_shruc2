package edu.aku.hassannaqvi.tpvics_shruc_r2.core;

import static edu.aku.hassannaqvi.tpvics_shruc_r2.database.DatabaseHelper.DATABASE_NAME;
import static edu.aku.hassannaqvi.tpvics_shruc_r2.database.DatabaseHelper.DATABASE_PASSWORD;
...
public class MainApp extends Application {
    ...
    public static final String PROJECT_NAME = "TPVICS_SHRUC_R2";
    ...
    public static final String _UPDATE_URL = MainApp._IP + "/tpvics_shruc_r2/app/survey";
    ...
    public static int versionCode = edu.aku.hassannaqvi.tpvics_shruc_r2.BuildConfig.VERSION_CODE;
    public static String versionName = edu.aku.hassannaqvi.tpvics_shruc_r2.BuildConfig.VERSION_NAME;
