...
import static edu.aku.hassannaqvi.tpvics_shruc_r2.core.CipherSecure.decryptGCM;
import static edu.aku.hassannaqvi.tpvics_shruc_r2.core.CipherSecure.encryptGCM;
import static edu.aku.hassannaqvi.tpvics_shruc_r2.core.CipherSecure.hashSHA256;
...
import static edu.aku.hassannaqvi.tpvics_shruc_r2.database.DatabaseHelper.DATABASE_COPY;
import static edu.aku.hassannaqvi.tpvics_shruc_r2.database.DatabaseHelper.DATABASE_NAME;
...
import edu.aku.hassannaqvi.tpvics_shruc_r2.MainActivity;
import edu.aku.hassannaqvi.tpvics_shruc_r2.R;
import edu.aku.hassannaqvi.tpvics_shruc_r2.contracts.TableContracts;
import edu.aku.hassannaqvi.tpvics_shruc_r2.core.AppInfo;
...
import edu.aku.hassannaqvi.tpvics_shruc_r2.databinding.ActivityLoginBinding;
   ...
   /* private int PhotoSerial = 0;
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.tpvics_shruc_r2.ui.SyncActivity.class).putExtra("login", true));
        } else {
